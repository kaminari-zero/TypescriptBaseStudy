...
var ArrayFun;
(function (ArrayFun) {
    var ArrayFunTest = (function () {
        function ArrayFunTest() {
        }
        /**
         * Array 对象是用于构造数组的全局对象; 它是高阶的、类似于列表的对象。
         */
        ArrayFunTest.arrayBaseTest = function () {
            //创建数组
            ...
            //删除数组末尾的元素
            var last2 = fruits.pop(); // ["Apple", "Banana"];
            console.log(fruits);
            //删除数组最前面（头部）的元素
            var first2 = fruits.shift();
            console.log(fruits);
            //添加到数组的前面（头部）
            var newLength2 = fruits.unshift("Strawberry"); // ["Strawberry", "Banana"];
            console.log(fruits);
            //找到某个元素在数组中的索引
            ...
            console.log(fruits);
            //通过索引删除某个元素
            var removedItem = fruits.splice(1, 1); // ["Strawberry", "Mango"]
            console.log(fruits);
            //复制一个数组
         ...
         */
        ArrayFunTest.lengthTest = function () {
            var fruits = [];
         ...
         * 二维数组
         */
        ArrayFunTest.Two_dimension_arrayTest = function () {
            var board = [
                ['R', 'N', 'B', 'Q', 'K', 'B', 'N', 'R'],
                ['P', 'P', 'P', 'P', 'P', 'P', 'P', 'P'],
                [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
         ...
         * 注：
         */
        ArrayFunTest.isArrayTest = function () {
         ...
         */
        ArrayFunTest.stringEeveryTest = function () {
    ...
    ArrayFun.ArrayFunTest = ArrayFunTest;
    __reflect(ArrayFunTest.prototype, "ArrayFun.ArrayFunTest");
})(ArrayFun || (ArrayFun = {}));
