...
(function (ArrayFun) {
     ...
     */
    var ArrayAccessorFunTest = (function () {
        function ArrayAccessorFunTest() {
        }
        /**
         ...
         * 返回值：新的 Array 实例。
         */
        ArrayAccessorFunTest.concatTest = function () {
            var num1 = [[1]];
            var num2 = [2, [3]];
         ...
         */
        ArrayAccessorFunTest.joinTest = function () {
         ...
         * 返回值：一个含有提取元素的新数组
         */
        ArrayAccessorFunTest.sliceTest = function () {
         ...
         */
        ArrayAccessorFunTest.toStringTest = function () {
         ...
         */
        ArrayAccessorFunTest.toLocaleStringTest = function () {
            var number = 1337;
            var date = new Date();
         ...
         */
        ArrayAccessorFunTest.indexOfTest = function () {
            var arrays = [2, 5, 9];
         ...
         * 参数与返回值与上面的indexOf一致。
         */
        ArrayAccessorFunTest.lastIndexOfTest = function () {
            var arrays = [2, 5, 9, 2];
        ...
        return ArrayAccessorFunTest;
    }());
    ArrayFun.ArrayAccessorFunTest = ArrayAccessorFunTest;
    __reflect(ArrayAccessorFunTest.prototype, "ArrayFun.ArrayAccessorFunTest");
})(ArrayFun || (ArrayFun = {}));
//# sourceMappingURL=ArrayAccessorTest.js.map