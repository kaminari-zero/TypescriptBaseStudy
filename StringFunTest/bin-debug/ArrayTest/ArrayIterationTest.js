...
(function (ArrayFun) {
     ...
     * 注：下面大多方法都是es5的。
     */
    var ArrayIterationFunTest = (function () {
        function ArrayIterationFunTest() {
        }
        /**
         ...
         *
         */
        ArrayIterationFunTest.forEachTest = function () {
         ...
         * 对象复制函数
         */
        ArrayIterationFunTest.CopyObjectTest = function () {
            function copy(obj) {
         ...
         */
        ArrayIterationFunTest.everyTest = function () {
            //检测所有数组元素的大小
         ...
         */
        ArrayIterationFunTest.someTest = function () {
            //测试数组元素的值
            function isBigEnough(element, index, array) {
                return (element >= 10);
            }
         ...
         */
        ArrayIterationFunTest.filterTest = function () {
            //筛选排除掉所有的小值
         ...
         */
        ArrayIterationFunTest.mapTest = function () {
            //求数组中每个元素的平方根
            var numbers = [1, 4, 9];
         ...
         */
        ArrayIterationFunTest.mapExampleTest = function () {
            ...
            // 意料之中的结果
            // 也可以使用简单的箭头函数，结果同上
            console.log(['1', '2', '3'].map(function (str) { return parseInt(str); }));
            // 一个更简单的方式:
         ...
         */
        ArrayIterationFunTest.reduceTest = function () {
            var maxCallback = function (pre, cur) { return Math.max(pre.x, cur.x); };
            ...
            result = [{ x: 22 }, { x: 42 }].map(function (el) { return el.x; })
            ...
            //把上面改成箭头函数写法：
            var total = [0, 1, 2, 3].reduce(function (acc, cur) { return acc + cur; }, 0);
            console.log(total);
         ...
         */
        ArrayIterationFunTest.reduceRightTest = function () {
        ...
        return ArrayIterationFunTest;
    }());
    ArrayFun.ArrayIterationFunTest = ArrayIterationFunTest;
    __reflect(ArrayIterationFunTest.prototype, "ArrayFun.ArrayIterationFunTest");
})(ArrayFun || (ArrayFun = {}));
//# sourceMappingURL=ArrayIterationTest.js.map