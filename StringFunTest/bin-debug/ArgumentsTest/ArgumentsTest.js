...
(function (ArgumentsTest) {
    var ArgumentsFunTest = (function () {
        function ArgumentsFunTest() {
        }
        /**
         * arguments基础：
         ...
         */
        ArgumentsFunTest.argumentsBaseTest = function () {
            //arguments对象不是一个 Array 。它类似于Array，但除了长度之外没有任何Array属性。
            //例如，它没有 pop 方法。但是它可以被转换为一个真正的Array：
            function testArgument(a, b, c, d, e, f, g) {
                var argss = [];
                for (var _i = 7; _i < arguments.length; _i++) {
                    argss[_i - 7] = arguments[_i];
                }
                //方式一：
         ...
         * 定义连接字符串的函数
         */
        ArgumentsFunTest.joinFunTest = function () {
            function myConcat(separator) {
                var argss = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    argss[_i - 1] = arguments[_i];
                }
         ...
         */
        ArgumentsFunTest.calleeTest = function () {
        ...
        return ArgumentsFunTest;
    }());
    ArgumentsTest.ArgumentsFunTest = ArgumentsFunTest;
    __reflect(ArgumentsFunTest.prototype, "ArgumentsTest.ArgumentsFunTest");
})(ArgumentsTest || (ArgumentsTest = {}));
//# sourceMappingURL=ArgumentsTest.js.map