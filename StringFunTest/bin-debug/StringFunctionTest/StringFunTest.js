...
var StringFun;
(function (StringFun) {
    var StringFunTest = (function () {
        function StringFunTest() {
        }
        /**
         * javascript 基本字符串方法
         */
        StringFunTest.StringBaseTest = function () {
            //长字符串
            //使用+号拼接
...
otherwise my code is unreadable.";
         ...
         */
        StringFunTest.charAtTest = function () {
         ...
         */
        StringFunTest.getAllChatTest = function () {
         ...
         * 可以使用以下：
         */
        StringFunTest.fixedCharAtTest = function () {
            var str = 'A \uD87E\uDC04 Z'; // 我们可以直接使用非BMP字符
            console.log(str);
            for (var i = 0, chr; i < str.length; i++) {
        ...
        return StringFunTest;
    }());
    StringFun.StringFunTest = StringFunTest;
    __reflect(StringFunTest.prototype, "StringFun.StringFunTest");
})(StringFun || (StringFun = {}));
//# sourceMappingURL=StringFunTest.js.map