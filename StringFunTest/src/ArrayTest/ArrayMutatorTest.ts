namespace ArrayFun{
     ...
     */
    export class ArrayMutatorFunTest{
        /**
         * pop()方法从数组中删除最后一个元素，并返回该元素的值。此方法更改数组的长度。
         * 返回值：从数组中删除的元素(当数组为空时返回undefined)。
         */
        public static popTest(){
            let a = [1, 2, 3];
