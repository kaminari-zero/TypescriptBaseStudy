namespace StringFun{
    export class StringFunTest2{
         ...
         */
        public static indexOfAndLastTest(){
         ...
         * 
         */
        public static fStrConvJsonTest(){
            var str = 'x-x_';
            var retArr = [];
