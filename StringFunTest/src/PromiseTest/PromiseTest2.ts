namespace PromiseExample{
    export class PromiseTest2{
         ...
         */
        public static promiseResolveTest(){
            //(2)
            ...
            const p2 = Promise.resolve();//直接获得一个pormise对象
            p2.then(function () {
                // ...
            });       
        }
         ...
         */
        public static promiseResolveTest2(){
            setTimeout(function () {
                console.log('three');
            }, 0);
         ...
         */
        public static promiseRejectTest(){
