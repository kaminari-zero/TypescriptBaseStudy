...
var RegexExample = (function () {
    function RegexExample() {
    }
    /**
     * 匹配以数字结尾的:
     */
    RegexExample.IsNumberWithEndTest = function () {
        var regex = /\d+$/g;
     ...
     * 去掉空格
     */
    RegexExample.SpaceDelTest = function () {
        var str = "我 是 龙 恩";
     ...
     * 电话号码正则
     */
    RegexExample.IsPhoneTest = function () {
        //分析如下：
     ...
     * 手机号码正则
     */
    RegexExample.IsTelPhoneTest = function () {
        var str = 15606512345;
     ...
     *  删除字符串左右空格
     */
    RegexExample.TrimTest = function () {
        var str1 = " 1234 ";
        /*
     ...
     */
    RegexExample.InputNumberTest = function () {
     ...
     * 替换小数点前面的内容为指定内容
     */
    RegexExample.ReplacePointContentTest = function () {
        var href = "aa.php?d=1";
     ...
     * 匹配中文的正则
     */
    RegexExample.IsChineseTest = function () {
     ...
     *  返回字符串中 中文字符的个数
     */
    RegexExample.GetChineseCharTest = function () {
     ...
     *  匹配标签中的内容
     */
    RegexExample.ReplaceLableContentTest = function () {
        /**
     ...
     * 匹配标签中的文本
     */
    RegexExample.GetLableTextTest = function () {
     ...
     * 从路径中获取文件名
     */
    RegexExample.GetFileNameTest = function () {
        var s1 = "c:\\images\\tupian\\006.jpg", s2 = "c:\\images\\tupian\\aa.jpg", s3 = "c:/images/tupian/test2.jpg", s4 = "C:\006.JPG", s5 = "c:\images\tupian\006.jpg";
        /**
         * 正则含义是：[^\\\/]* 不以一个\ 或者 2个\\
     ...
     * 绝对路径变成相对路径
     */
    RegexExample.GetPathConvertTest = function () {
        /**
     ...
     * 用户名正则
     */
    RegexExample.IsUserNameTest = function () {
     ...
     *  匹配英文地址
     */
    RegexExample.IsEnglishPathTest = function () {
     ...
     * 匹配价格
     */
    RegexExample.IsPriceTest = function () {
     ...
     * 身份证号码的匹配
     */
    RegexExample.IsIDCardTest = function () {
     ...
     * 单词的首字母大写
     */
    RegexExample.FirstLetterTest = function () {
        //匹配字符串，让其字符串的首个字母大写
     ...
     *  验证日期格式
     */
    RegexExample.IsDataTest = function () {
     ...
     * 验证邮箱的正则表达式
     */
    RegexExample.EmailTest = function () {
        //思路分析: 邮箱的规则是: 由3部分组成
     ...
     *  匹配代码中的a链接
     */
    RegexExample.ALinkTest = function () {
     ...
     * 正则判断标签是否闭合
     */
    RegexExample.IsLableCloseTest = function () {
     ...
     * 获取标签里面的内容
     */
    RegexExample.GetLableContentTest = function () {
        var str = "<div>111</div>";
     ...
     * 正则判断是否为数字和字母的混合
     */
    RegexExample.IsNumAndCharTest = function () {
        //规则：字母和数字的混合
     ...
     * 将阿拉伯数字转换为中文大写字符
     */
    RegexExample.NumConvChineseTest = function () {
     ...
     * 替换文本中的url为链接
     */
    RegexExample.ReplaceURLForLinkTest = function () {
...
__reflect(RegexExample.prototype, "RegexExample");
//# sourceMappingURL=RegexExample.js.map