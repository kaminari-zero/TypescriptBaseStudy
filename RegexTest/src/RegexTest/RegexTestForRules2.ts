...
class RegexTestForRules2{
     ...
     */
    public static CaptureGroupTest(){
        // 分组的列子
     ...
     */
    public static UnCaptureGroupTest(){
        // 非捕获性分组
        var num2 = "11 22";
        /#(?:\d+)/.test(num2);
     ...
     */
    public static ReverseReferenceTest(){
        var str = "longenaabcd";
     ...
     * 将字符串转换成正则表达式
     */
    public static StringConvRegexTest(){
        var strReg = "/Hello/i";
        var strReg2 = "//Hello//i";
        var strReg3 = "Hello";
     ...
     *  g ：全文查找
     */
    public static QuanWenSearchTest(){
        var reg=/\d/;
     ...
     * i ：忽略大小写
     */
    public static HuLueDaXiaoXieTest(){
        var reg = /a/i;
        var str1 = "AAA9BBBB2CCCC3DDDD";
     ...
     * m：多行查找(默认是非贪婪模式)
     */
    public static HuangHangSearchTest(){
        //例：全文查找        替换所有的A
        var reg = /A/g;
