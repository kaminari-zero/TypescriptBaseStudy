...
class RegexTestForRules{
     ...
     */
    public static metacharacterTest(){
        var str = "abcde";
     ...
     * 如下代码匹配：
     */
    public static OrderToLookAroundTest(){
        var str2 = "a12";
        //顺序肯定环视（具体解析如上）
