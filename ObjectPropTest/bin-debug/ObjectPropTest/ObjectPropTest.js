...
var ObjectProp;
(function (ObjectProp) {
    var ObjectPorpTest = (function () {
        function ObjectPorpTest() {
        }
        /**
         * 使用 hasOwnProperty 。
         * 返回一个布尔值，指示对象是否具有指定的属性作为自身（不继承）属性。
         */
        ObjectPorpTest.hasOwnPropertyTest = function () {
            var o = new Object();
            o.prop = 'exists';
            function changeO() {
                o.newprop = o.prop;
         ...
         */
        ObjectPorpTest.getOwnPropertyNamesTest = function () {
            var arr = ["a", "b", "c"];
         ...
         * 只获取不可枚举的属性
         */
        ObjectPorpTest.getUnEnumerablePropTest = function (myObject) {
            var target = myObject;
         ...
         * 遍历一个对象的所有自身属性
         */
        ObjectPorpTest.getObjectOwnProp = function (obj) {
            for (var name in obj) {
         ...
         * 白鹭一些对对象操作的方法
         */
        ObjectPorpTest.egretClassFunTest = function (obj) {
            //白鹭提供的获得对象的类的名字
         ...
         * 获取类名，非白鹭方式
         */
        ObjectPorpTest.getClassNameTest = function (obj) {
            console.log(obj.__class__);
        };
        /**
         * 获取其类类型（本类，父类，接口）
         */
        ObjectPorpTest.getClassTypeTest = function (obj) {
         ...
         * 获取其原型
         */
        ObjectPorpTest.getPrototypeTest = function (obj) {
            //直接获取对象的原型
         ...
         */
        ObjectPorpTest.getConstructorTest = function (obj) {
         ...
         */
        ObjectPorpTest.getOwnPropertyDescriptorTest = function () {
            var o, d;
            o = { get foo() { return 17; } };
         ...
         */
        ObjectPorpTest.useInTest = function () {
            // 数组
         ...
         * 使用toString()检测对象类型
         */
        ObjectPorpTest.toStringTypeTest = function () {
        ...
        return ObjectPorpTest;
    }());
    ObjectProp.ObjectPorpTest = ObjectPorpTest;
    __reflect(ObjectPorpTest.prototype, "ObjectProp.ObjectPorpTest");
})(ObjectProp || (ObjectProp = {}));
//# sourceMappingURL=ObjectPropTest.js.map